export const dataSkills = [
  ...
  { id: 12, name: "TYPESCRIPT", dev: "FRONT END" },
  { id: 13, name: "REACT JS", dev: "FRONT END" },
  { id: 14, name: "VUE JS", dev: "FRONT END" },
  { id: 15, name: "BOOTSTRAP", dev: "FRONT END" },
  { id: 16, name: "MUI", dev: "FRONT END" },
